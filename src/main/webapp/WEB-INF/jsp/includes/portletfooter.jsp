                        ...
                        <div class="col-md-6">
                            <ul class=" text-left">
                                ...
                                <a href="http://www.ptd.gov.bd/">
                                    <li class="roboto fw-300" style="font-size: 14px;list-style-type: none;"> Ministry of Post,Telecommunication </li>
                                    <li class="roboto fw-300" style="font-size: 14px;list-style-type: none;"> and Information Technology </li>
                                </a>
                                <a href="http://a2i.pmo.gov.bd/">
                                    <li class="roboto fw-300" style="font-size: 14px;list-style-type: none;">a2i Programme</li>
                                </a>
                        ...
                        <div class="col-md-3" style="display: flex;flex-direction: column;justify-content: center;align-items: center;">
                            ...
                            <div class="logo_a2i" style="margin-top:5%;">
                                <div class="logo_a2i" style="margin-top:5%;">
                                    ...
                                    <%--<img src="<%=Srequest.getContextPath()%>/assets/portal/img/logo/a2i.png" width="41"
