                          ...
                          <div class="portlet box bordered " >
                              <div class="portlet-title">
                                  <div class="caption">
                                      ...
                                      <span class="caption-subject font-dark sbold uppercase">Add Menu Form</span>
                                  </div>
                                  ...
                                  <form method="post" action="${context}/addmenu"  class="form-horizontal"
                                      ...
                                      <div class="form-body">
                                          ...
                                          <div class="form-group">
                                              <label class=" col-md-3 control-label" >Menu Name English <span
                                          ...
                                          <div class="form-group">
                                              <label class=" col-md-3 control-label">Menu Name Bangla <span
                                                      class="required" aria-required="true"> * </span></label>
