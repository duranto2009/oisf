                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet box bordered">
                                    <div class="portlet-title ">
                                        <div class="caption">
                                            <span class="caption-subject">Group Policy Add Form</span>
                                        </div>
                                        <%--<div class="actions">--%>
                                        ...
                                        <form method="post"  id = "form" action="${context}/grouppolicyadd">
                                            <div class=" form-body">
                                                ...
                                                <div class="form-group col-md-12">
                                                    <label class="col-md-3 control-label" style="margin-left: -30px;">Name English</label>
                                                    <div class="col-md-6">
                                                ...
                                                <div class="form-group col-md-12">
                                                    <label class="col-md-3 control-label" style="margin-left: -30px;">Name Bangla</label>
                                                    <div class="col-md-6">
                                                        <div class="input-icon">
                                                            ...
                                                            <input type="text" data-required="1" class="form-control"
                                                                   placeholder="Menu Name in Bangla"
                                                                   name="menunamebng">
