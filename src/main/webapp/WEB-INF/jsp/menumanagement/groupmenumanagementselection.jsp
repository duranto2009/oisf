                                       ...
                                       <form method="post" id="form" action="/groupassign">
                                           <div class=" form-body">
                                               <div class="form-group col-md-12">
                                                   <label class="col-md-3 control-label" style="margin-left: -30px;">Office
                                                       Ministry</label>
                                                   <div class="col-md-6">
                                               ...
                                               <div class="form-group col-md-12">
                                                   <label class="col-md-3 control-label" style="margin-left: -30px;">Origin
                                                       Office Name</label>
                                                   <div class="col-md-6">
                                               ...
                                               <div class="form-group">
                                                   ...
                                                   <label for="multiple" class="control-label">Select Group</label>
