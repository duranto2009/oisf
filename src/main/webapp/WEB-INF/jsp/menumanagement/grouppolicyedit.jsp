                                        ...
                                        <form method="post"  id = "form" action="/grouppolicyassign">
                                            <div class=" form-body">
                                                ...
                                                <div class="form-group col-md-12">
                                                    <label class="col-md-3 control-label" style="margin-left: -30px;">Group Policy Name English</label>
                                                    <div class="col-md-6">
                                                ...
                                                <div class="form-group col-md-12">
                                                    <label class="col-md-3 control-label" style="margin-left: -30px;">Group Policy Name Bangla</label>
                                                    <div class="col-md-6">
                                                        <input type="text" data-required="1" class="form-control"
