                ...
                <div class="card-block">
                    <div class="portlet box " >
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-picture"></i>Menu List
                            </div>
                        ...
                        <div class="portlet-body">
                            <div class=" pull-right" id="addassign" style="margin-bottom: 40px;margin-top: 10px">
                                <button type="button" class="btn " style="margin-right: 30px; background-color: #adadce"><a href="<%=request.getContextPath()%>/addmenu">Add Menu</a></button>
...
//        if(his!=undefined)hvisible = true;
        ...
        example_table = $('#datatable').DataTable({
            ...
            "language":{
                ...
                "info":           " মোট _TOTAL_ মেনুর মধ্যে _START_ থেকে _END_ পর্যন্ত দেখানো হচ্ছে",
