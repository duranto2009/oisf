...
<div class="first">
    <div class="container second" style="margin-top: 100px;">
        <pre style="font-size: 20px"> Home > <a class="urllink" href="<%=request.getContextPath()%>/portal#service">Services</a> <c:if test="${bool==0}"> > <a class="urllink" href="/portal/corelist">${urltitle} Services</a></c:if><c:if test="${bool==1}"> > <a class="urllink" href="/portal/sharedlist">${urltitle} Services</a></c:if> > ${urlnames.nameEng} </pre>
    </div>
