                        ...
                        <div class="card-block">
                            <div class="portlet box ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-picture"></i>Service List
                                    </div>
                                ...
                                <%--<div class="mt-list-container list-default">--%>
                                    ...
                                    <%--<ul class="list-default">--%>
                                        ...
                                        <%--<c:forEach var="data" items="${services}">--%>
                                            <%--<li class="mt-list-item"><a href="<%=request.getContextPath()%>/portal/servicemeta/${data.getServiceId()}">--%>
                                                    <%--${data.getNameEng()}--%>
                                            <%--</a>--%>
                                            <%--</li>--%>
                                        <%--</c:forEach>--%>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/static/assets/js/common/modalcontrol.js"></script>
<script>
    ...
    example_table = $('#datatable').DataTable({
        ...
        "language": {
            ...
            "info": " Showing _START_ to _END_ of  _TOTAL_ Module Entries",
        ...
        "ajax": {
            "url":"<%=request.getContextPath()%>/portal/services/",
            "type":"POST",
            "data":{
                id:${id}
            }
        ...
        "aoColumns": [

            {
                "mRender": function(data, type, full) {
                    ...
                    var link = '<a href="/portal/servicemeta/'+full.serviceId+'">'+full.nameEng+'</a>';
                    return link;
                },
