                ...
                <div class="card-block">
                    <div class="portlet box " >
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-picture"></i>Application List
                            </div>
            ...
            'columns': [
                ...
                {data: 'notificationFlag'},
                {
                    "mRender": function (data, type, full) {
                        ...
                        return '<form method="post" action="${context}/editapp">' +
                ...
                },
                {
                    "mRender": function (data, type, full) {
                        ...
                        return '<button class="btn btn-outline link-button btn-danger"  onclick=showModal(' + full.id + ',\"/deleteapp\","Application")>' +
                            '<i class="fa fa-trash-o fa-lg"></i>' +
                            '</button>';
