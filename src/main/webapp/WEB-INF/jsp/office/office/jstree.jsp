                ...
                <div class="col-md-6">
                    <div class="portlet green-sharp box">
                        ...
                        <div class="portlet-body">
                            <div id="using_json_4" class="demo" style=" width: 400px;height: 800px; overflow-y: auto; overflow-x: hidden;">
                ...
                <div class="col-md-6">
                    <div class="portlet green-sharp box">
                        ...
                        <div class="portlet-body" id="blockui_sample_4_portlet_body">
                            <div id="using_json_3" class="demo" style="width: 400px; height: 800px; overflow-y: auto; overflow-x: hidden;">
            ...
            'core' : {
                'data': {
                    ...
                    'url': function (node) {
                        ...
                        var res = str.split("-");
                        if(res[0]=="#"){
                            return   '<%=request.getContextPath()%>/officeoriginroot';
                        }
                        else if(res[0]=="originroot"){
                            return   '<%=request.getContextPath()%>/getofficeoriginunitlistforjstreebyofficeoriginid';
                        }
                        else if(res[0]=="officeoriginunit"){
                            return   '<%=request.getContextPath()%>/getofficeoriginunitlistforjstreebyofficeoriginunitid';
                        }
                        else if(res[0]=="officeoriginunitorganogram"){
                            return   '<%=request.getContextPath()%>/getofficeunitorganogramforjstreebyofficeunitid';
                        }
                    ...
                    'data': function (node) {
                        ...
                        else return {'id':${officeOriginId}, "li_attr": "", "a_attr": ""};
                    }
