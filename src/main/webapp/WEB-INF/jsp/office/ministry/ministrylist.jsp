                        ...
                        <div class="portlet-body">
                            ...
                            <div class=" table-scrollable table-responsive">
                                <table class="table  table-striped  table-hover" id="datatable">
                                    ...
                                    <th >Ministry Name</th>
                                    <th >Ministry Name(Bangla) </th>
                                    <th >Ministry Short Name(English)</th>
    ...
    function datatableInit(edi,del,his) {
        ...
        example_table = $('#datatable').DataTable({
            ...
            "aoColumns"   :[
                ...
                {
                    "mRender": function(data, type, full) {
                        return '<button class="btn btn-icon-only" style="background-color: black;color: white" onclick=showModal('+full.id+',\"/ministrydelete\")>'+
...
//                    else  if(x.indexOf("history")>=0)list["history"]={ispresent:1,nameeng:response[i].nameEng,namebng:response[i].nameBng,url:response[i].url};
                ...
                if(list[2]==1)addassign.append('<button type="button" class="btn " style="margin-right: 30px; background-color: #adadce"><a href="${context}/ministryadd">Add Ministry</a></button>');
