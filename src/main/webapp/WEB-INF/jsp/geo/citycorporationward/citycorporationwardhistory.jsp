                        ...
                        <div class="portlet box bordered">
                            ...
                            <div class="portlet-body">
                                <div>
                                    ...
                                    <input id="citycorporationwardname" type="hidden" value="${name}"/>
...
<script>
    ...
    function currentChain(data) {
        ...
        var presentCondition ='বর্তমান অবস্থা : <br/><br/> সিটি কর্পোরেশন ওয়ার্ডটি <a href="${context}/upazillahistory?id='+data.upazilaId+'&&name='+data.upazilaName+'">'+data.upazilaName+'</a>'+
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            type:"GET",
            url : "${context}/historycitycorporationward",
            data : {
                id: $("#historyid").val()
            },
            async: false,
            success : function(response) {
                var intro = '<h3>'+$("#citycorporationwardname").val()+' একটি সিটি কর্পোরেশন ওয়ার্ড। </h3>';
