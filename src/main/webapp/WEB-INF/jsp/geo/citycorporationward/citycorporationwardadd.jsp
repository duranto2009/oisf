...
<div class="page-container">
                    ...
                    <div class="portlet box bordered ">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-dark sbold ">City Corporation ward Form</span>
                            </div>
                            ...
                            <form:form method="post" action="${context}/addcitycorporationward" class="form-horizontal"
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        <label class=" col-md-3 control-label">ward Name English <span
                                    ...
                                    <div class="form-group">
                                        <label class=" col-md-3 control-label">ward Name Bangla <span
                                                class="required" aria-required="true"> * </span></label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <select class="form-control" name="divdata" id="divisiondropdown">
                                                <option value="-1" disabled="disabled"selected="true">
                                                        Select Division
                                                </option>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">City Corporation Name</label>
                                        <div class="col-md-6">
    ...
    <script> $(document).ready(function () {
        ...
        $('#districtdropdown').change(function () {
            ...
            select.empty();
            select.append($('<option></option>').val(-1).prop('disabled','disabled').html('Select City Corporation'));
            $.each(data, function (index, value) {
                select.append(
