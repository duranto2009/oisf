...
//                    else  if(x.indexOf("history")>=0)list["history"]={ispresent:1,nameeng:response[i].nameEng,namebng:response[i].nameBng,url:response[i].url};
                ...
                if(list[2]==1)addassign.append('<button type="button" class="btn " style="margin-right: 30px; background-color: #adadce"><a href="${context}/divisionadd">Add Division</a></button>');
                if(list[5]==1)addassign.append('<button type="button" class="btn " style="margin-right: 30px; background-color: #adadce"><a href="${context}/divisionassign">Assign District</a></button>');
