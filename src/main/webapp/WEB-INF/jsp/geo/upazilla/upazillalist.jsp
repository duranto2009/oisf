    ...
    $(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (list[2] == 1) addassign.append('<button type="button" class="btn " style="margin-right: 30px; background-color: #adadce"><a href="${context}/upazillaadd">Add Upazilla</a></button>');
                if(list[5]==1){
                    addassign.append('<button type="button" class="btn " style="margin-right: 30px; background-color: #adadce"><a href="${context}/upazillaunionassign">Assign Union</a></button>')
                    addassign.append('<button type="button" class="btn " style="margin-right: 30px; background-color: #adadce"><a href="${context}/upazillamunicipalityassign">Assign Municipality</a></button>')
                };
