                            ...
                            <div class="dropdown dropdown-lg">
                                ...
                                <div class="dropdown-menu dropdown-menu-right advanced-file-search" role="menu"
                                    ...
                                    <div>
                                        ...
                                        <label class="control-label">Upazila<span
                                                class="required" aria-required="true"> * </span></label>
    ...
    function datatableInit(edi,del,his) {
        ...
        example_table = $('#datatable').DataTable({
            ...
            "aoColumns"   :[
                ...
                {
                    "mRender": function(data, type, full) {
                        return '<button class="btn btn-icon-only" style="background-color: black;color: white" onclick=showModal('+full.id+',\"/uniondelete\")>'+
    ...
    $(document).ready(function () {
        $.ajax({
            ...
            success: function (response) {
                ...
                if (list[2] == 1) addassign.append('<button type="button" class="btn " style="margin-right: 30px; background-color: #adadce"><a href="${context}/unionadd">Add Union</a></button>');
