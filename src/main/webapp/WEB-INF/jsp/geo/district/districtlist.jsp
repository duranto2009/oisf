      ...
      //  $("body > div.page-container > div.page-content-wrapper > div > div.card > div > div > div.portlet-body > div.table-scrollable.table-responsive").css('display','none');
        $.ajax({
            ...
            success : function(response) {
                ...
                if(list[2]==1)addassign.append('<button type="button" class="btn " style="margin-right: 30px; background-color: #adadce"><a href="${context}/districtadd">Add District</a></button>');
                if(list[5]==1){
                    addassign.append('<button type="button" class="btn " style="margin-right: 30px; background-color: #adadce"><a href="${context}/districtupazillaassign">Assign Upazilla</a></button>')
                    addassign.append('<button type="button" class="btn " style="margin-right: 30px; background-color: #adadce"><a href="${context}/districtthanaassign">Assign Thana</a></button>')
                };
