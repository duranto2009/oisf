                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet box bordered">
                                    ...
                                    <div class="portlet-body">
                                        <form method="post" action="${context}/districtassign">
                                            <div class=" form-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label for="multiple" class="control-label">Select District</label>
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <label class="control-label col-md-12" style="width: auto">Select Upazilla</label>
...
<script>
    ...
    function fetchall() {
        ...
        url = "${context}/getupazilalistbydistrictids"
