                                    ...
                                    <div class="form-actions">
                                        <div class="row">
                                            <div class="col-md-offset-3 col-md-9">
                                                ...
                                                <button type="button"  onclick= "location.href='${context}/postofficelistview'" class="btn btn-circle grey-salsa btn-outline">Cancel</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
...
<script> $(document).ready(function() {
    ...
    $('#districtdropdown').change(function() {
        ...
        select.empty();
        select.append($('<option></option>').val(-1).prop('disabled','disabled').html('Select Thana'));
        $.each(data, function(index, value) {
            select.append(
