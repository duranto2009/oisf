                        ...
                        <div class="portlet box bordered">
                            ...
                            <div class="portlet-body">
                                <div>
                                    ...
                                    <input id="postofficename" type="hidden" value="${name}"/>
...
<script>
    ...
    function currentChain(data) {
        var presentCondition ='বর্তমান অবস্থা : <br/><br/> পোস্ট অফিসটি <a href="${context}/districthistory?id='+data.districtId+'&&name='+data.districtName+'">'+data.districtName+'</a>'+
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            type:"GET",
            url : "${context}/historypostoffice",
            data : {
                id: $("#historyid").val()
            },
            async: false,
            success : function(response) {
                var intro = '<h3>'+$("#postofficename").val()+' একটি পোস্ট অফিস। </h3>';
