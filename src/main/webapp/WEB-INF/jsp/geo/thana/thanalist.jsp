                ...
                <div class="card-block">
                    <div class="portlet box " >
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-picture"></i>Thana List
                            </div>
    ...
    function datatableInit(edi,del,his) {
        ...
        example_table = $('#datatable').DataTable({
            ...
            "aoColumns"   :[
                ...
                {
                    "mRender": function(data, type, full) {
                        return '<button class="btn btn-icon-only" style="background-color: black;color: white" onclick=showModal('+full.id+',\"/thanadelete\")>'+
    ...
    $(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (list[2] == 1) addassign.append('<button type="button" class="btn " style="margin-right: 30px; background-color: #adadce"><a href="/thanaadd">Add Thana</a></button>');
