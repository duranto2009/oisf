    ...
    function childDetail(data) {
        ...
        for(var i =0;i<data.length;i++){
            if(data[i].sourceType == 6){
                fromWhomCityBuildUp +='<li><a href="${context}/unionhistory?id='+data[i].unionId+'&&name='+data[i].unionName+'">'+data[i].unionName+'</a></li>';
            }
            else{
              muni =true;
            }
        ...
        for(var i =0;i<data.length;i++){
            if(data[i].sourceType == 7){
                fromWhomCityBuildUp +='<li><a href="${context}/municipalityhistory?id='+data[i].municipalityId+'&&name='+data[i].municipalityName+'">'+data[i].municipalityName+'</a></li>';
            }
