...
<form action="" method="post" id="${context}/oisfForm" target="_blank">
                    ...
                    <div class="portlet box bordered ">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-dark sbold uppercase">city Form</span>
                            </div>

                        </div>
                        <div class="portlet-body">
                            <form method="post" action="${context}/addcitycorporation" class="form-horizontal"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <select class="form-control" name="divdata" id="divisiondropdown">
                                                <option value="-1"disabled="disabled"selected="selected"> Select Division</option>
