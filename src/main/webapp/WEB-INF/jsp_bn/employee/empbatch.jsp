                ...
                <div class="card-block">
                    <div class="portlet box " >
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-picture"></i>  ব্যাচ  তালিকা
                            </div>
                        </div>
                        <div class="portlet-body">
                            <div class=" pull-right" id="addassign" style="margin-bottom: 40px;margin-top: 10px">

                                <button type="button" class="btn " style="margin-right: 30px; background-color: #adadce"><a href="/empbatchadd"> ব্যাচ সংযুক্ত করুন  </a>
                                </button>
                            </div>
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#datatable').dataTable({
            ...
            "sEcho":1,
            "sAjaxSource" : "<%=request.getContextPath()%>/batchpage",
            "iDisplayLength": 10,
            ...
            "aoColumns"   :[
                ...
                {"mData": "batchYear"},
                {
                    "mRender": function(data, type, full) {
                        ...
                        return '<form method="post" action="${context}/editempbatch">'+
                            '<input type="hidden" name="id" value="'+full.id+'">'+
                            '<input type="hidden" name="batchNo" value="'+full.batchNo+'">'+
                            '<input type="hidden" name="batchYear" value="'+full.batchYear+'">'+
                ...
                },
                {
                    "mRender": function(data, type, full) {
                        ...
                        return '<form method="post" action="${context}/empbatchdelete">'+
                            '<input type="hidden" name="id" value="'+full.id+'">'+
