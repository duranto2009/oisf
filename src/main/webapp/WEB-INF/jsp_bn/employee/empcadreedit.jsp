                           ...
                           <div class="portlet box bordered ">
                               <div class="portlet-title">
                                   <div class="caption">
                                       ...
                                       <span class="caption-subject font-dark sbold uppercase"> ক্যাডার তৈরি করুন </span>
                                   </div>

                               </div>
                               <div class="portlet-body">
                                   <form method="post" action="${context}/empcadreedit"  class="form-horizontal"
                                       ...
                                       <div class="form-body">
                                           ...
                                           <div class="form-group">
                                               <label class=" col-md-3 control-label" > ক্যাডার নাম ( ইংরেজিতে)  <span
                                               ...
                                               <div class="col-md-6">
                                                   <div class="input-icon">
                                                       ...
                                                       <input type="text" data-required="1" class="form-control"
                                                              placeholder=" ইংরেজিতে ক্যাডার নাম লিখুন  "
                                                              value = "${cadre.cadreNameEng}"
                                                              name="cadreNameEng">
                                           ...
                                           <input type="hidden" data-required="1" class="form-control"
                                                  ...
                                                  name="id" value="${cadre.id}">

                                           <div class="form-group">
                                               <label class=" col-md-3 control-label"> ক্যাডার নাম  (বাংলাতে) <span
                                                       class="required" aria-required="true"> * </span></label>
                                               ...
                                               <div class="col-md-6">
                                                   <div class="input-icon">
                                                       ...
                                                       <input type="text" data-required="1" class="form-control"
                                                              placeholder=" বাংলাতে ক্যাডার নাম লিখুন  "
                                                              value = "${cadre.cadreNameBng}"
                                                              name="cadreNameBng">
