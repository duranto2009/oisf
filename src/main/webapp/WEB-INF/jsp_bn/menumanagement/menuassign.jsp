                                       ...
                                       <form method="post"  id = "form" action="${context}/menuassign">
                                           <div class=" form-body">
                                               <div class="form-group col-md-12">
                                                   <label class="col-md-3 control-label" style="margin-left: -30px;"> মন্ত্রনালয়</label>
                                                   <div class="col-md-6">
                                               ...
                                               <div class="form-group col-md-12">
                                                   <label class="col-md-3 control-label" style="margin-left: -30px;"> দপ্তরের স্তরের নাম</label>
                                                   <div class="col-md-6">
                                               ...
                                               <div class="form-group col-md-12">
                                                   <label class="col-md-3 control-label" style="margin-left: -30px;">  বিভা নাম</label>
                                                   <div class="col-md-6">
                                               ...
                                               <div class="form-group col-md-12">
                                                   <label class="col-md-3 control-label" style="margin-left: -30px;"> জেলা নাম</label>
                                                   <div class="col-md-6">
                                               ...
                                               <div class="form-group col-md-12">
                                                   <label class="col-md-3 control-label" style="margin-left: -30px;"> দপ্তরের নাম</label>
                                                   <div class="col-md-6">
                                               ...
                                               <div class="form-group col-md-12">
                                                   <label class="col-md-3 control-label" style="margin-left: -30px;"> দপ্তরের শাখার নাম</label>
                                                   <div class="col-md-6">
                                               ...
                                               <div class="form-group col-md-12">
                                                   <label class="col-md-3 control-label" style="margin-left: -30px;"> দপ্তরের পদসমূহের নাম</label>
                                                   <div class="col-md-6">
                                               ...
                                               <div class="form-group">
                                                   ...
                                                   <label for="multiple" class="control-label"> অ্যাপ  করুন</label>
...
<script>
    ...
    function fetchall() {
        ...
        $.ajax({
            ...
            error: function() {
                toastr.error("  কোন  সমস্যা হয়েছে , আবার চেষ্টা করুন  ।");
