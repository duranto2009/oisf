...
<head>
    ...
    <link href="<%=request.getContextPath()%>/assets/global/plugins/bootstrap-select/css/bootstrap-select.min.css" rel="stylesheet" type="text/css" />
    <link href="<%=request.getContextPath()%>/assets/global/plugins/jquery-multi-select/css/multi-select.css" rel="stylesheet" type="text/css" />
    <!-- Include the plugin's CSS and JS: -->
    <link rel="stylesheet" href="<%=request.getContextPath()%>/assets/css/bootstrap-multiselect.css" type="text/css"/>

    <link rel="stylesheet" href="<%=request.getContextPath()%>/assets/jstree/dist/themes/default/style.css" />
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet box bordered" s>
                                    ...
                                    <div class="portlet-body">
                                        <form method="post"  id = "form" action="/grouppolicyassign">
                                            <div class=" form-body">
                                                ...
                                                <div class="form-group col-md-12">
                                                    <label class="col-md-3 control-label" style="margin-left: -30px;"> গ্রুপ পলিছি নাম (ইংরেজিতে) </label>
                                                    <div class="col-md-6">
                                                ...
                                                <div class="form-group col-md-12">
                                                    <label class="col-md-3 control-label" style="margin-left: -30px;"> গ্রুপ পলিচি</label>
                                                    <div class="col-md-6">
                                                        <input type="text" data-required="1" class="form-control"
                                                               placeholder="Policy Name Bangla"
                                                ...
                                                <input type="hidden" name="policygroupid" value="${policy.getId()}"/>
                                                ...
                                                <div class="form-group col-md-12" style="margin-top: 40px">
                                                    ...
                                                    <label class="control-label col-md-12" style="width: auto"> মেনু বাছাই করুনu</label>
                                            ...
                                            <div class="form-actions">
                                                <div class="row">
                                                    <div class=" col-md-3" style="margin-left: 40%">
                                                        ...
                                                        <button type="button" onclick = "location.href='<%=request.getContextPath()%>/ministrylist?menuid=${sessionScope.grouppolicymenuid}'" class="btn btn-circle grey-salsa btn-outline"> বাতিল করুন</button>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            type: "POST",
            url: "<%=request.getContextPath()%>/selectedappForPolicyGroup",
            data: {
                policygroupid:  ${policy.getId()}
            },
            async: false,
            success: function (response) {
                var $select = $('#multiple');
        ...
        $.ajax({
            type: "POST",
            url: "<%=request.getContextPath()%>/getSelectedMenuForPolicyGroup",
            data: {
                policygroupid:  ${policy.getId()}
            },
            async: false,
            success: function (response) {
                ...
                $('#jstree').on('ready.jstree', function (e, data) {
                    ...
                    for(var i=0;i<response.length;i++) {
                        ...
                        data.instance.open_node(response[i]);
                        data.instance.select_node(response[i]);
...
<%--data = response;--%>
<%--for(var i=0;i<response.length;i++) {--%>
<%--$('#jstree').jstree('initially_select', "#"+response[i]);--%>
<%--previousMenuList["#_"+response[i]] =1;--%>
<%--}--%>
<%--state =0;--%>
<%--previousState = response;--%>
