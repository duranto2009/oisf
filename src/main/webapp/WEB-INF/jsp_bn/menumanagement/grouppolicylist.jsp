                ...
                <div class="card-block">
                    <div class="portlet box " >
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-picture"></i> গ্রুপ পলিছি তালিকা
                            </div>
                        ...
                        <div class="portlet-body">
                            <div class=" pull-right" id="addassign" style="margin-bottom: 40px;margin-top: 10px">
                                <button type="button" class="btn " style="margin-right: 30px; background-color: #adadce"><a href="<%=request.getContextPath()%>/grouppolicyadd">Add Group Policy</a></button>
                            </div>
...
<script>
    ...
    function datatableInit(edi,del,his) {
        var evisible = true, dvisible = true, hvisible=false;
        ...
        example_table = $('#datatable').DataTable({
            ...
            "language":{
                "decimal":        "১",
                "emptyTable":     "পলিসি খুজে পাওয়া যায় নাই",
                "info":           " মোট _TOTAL_ পলিসির মধ্যে _START_ থেকে _END_ পর্যন্ত দেখানো হচ্ছে",
                "infoEmpty":      "পলিসি খুজে পাওয়া যায় নাই",
                ...
                "search":         "",
                "zeroRecords":    "পলিসি খুজে পাওয়া যায় নাই",
                "paginate": {
                    "first":      "প্রথম",
                    "last":       "শেষ",
                    "next":       "পরে",
            ...
            "sAjaxSource" : "<%=request.getContextPath()%>/policylistdata",
            "iDisplayLength": 10,
            "iDisplayStart": 0,
            "aoColumns"   :[
                {   "mData": 'nameEng',
...

                {
                    "mRender": function(data, type, full) {
                        ...
                        editbtn.attr('action', "<%=request.getContextPath()%>/policyedit");
                ...
                },
                {
                    ...
                    "mRender": function(data, type, full) {
                        return '<button class="btn btn-icon-only" style="background-color: black;color: white">'+
                ...
                },
                {
                    "mRender": function(data, type, full) {
                        ...
                        var link = '<a href="/divisionhistory?id='+full.id+'&&name='+full.divisionNameBng+'"><button class="btn btn-icon-only"><i class="fa fa-info" style="color: black"></i></button></a>';
                        return link;
                    },
                    "bVisible":hvisible,
                    "bSortable": false
    ...
    $(document).ready(function () {
        datatableInit(undefined,undefined,undefined);
...
<script type="text/javascript"src="../assets/js/common/modalcontrol.js"></script>
