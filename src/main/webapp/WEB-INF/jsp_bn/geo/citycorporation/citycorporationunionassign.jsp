                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet box bordered" >
                                    ...
                                    <div class="portlet-body">
                                        <form method="post" action="${context}/assigncitycorporationunion">
                                            <div class=" form-body" style="display: flex;flex-direction: column;">
                                                <div class="form-group col-md-12">
                                                    <label class="col-md-3 control-label" style="margin-left: -30px;"> বিভাগের নাম </label>
                                                    <div class="col-md-6">
                                                ...
                                                <div class="form-group col-md-12">
                                                    <label class="col-md-3 control-label" style="margin-left: -30px;"> নতুন তৈরিকৃত সিটি কর্পোরেশন</label>
                                                    <div class="col-md-6">
                                            ...
                                            <div class="form-actions">
                                                <div class="row">
                                                    <div class=" col-md-3" style="margin-left: 40%">
                                                        ...
                                                        <button type="button"  onclick = "location.href='<%=request.getContextPath()%>/citycorporationlist?menuid=${sessionScope.citycorporationmenuid}'" class="btn btn-circle grey-salsa btn-outline"> বাতিল করুন </button>
