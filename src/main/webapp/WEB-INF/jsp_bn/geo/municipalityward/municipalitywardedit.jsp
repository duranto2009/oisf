                          ...
                          <div class="portlet box bordered ">
                              <div class="portlet-title">
                                  <div class="caption">
                                      ...
                                      <span class="caption-subject font-dark sbold uppercase">পৌরসভা  ওয়ার্ড তথ্য পরিবর্তন করুন </span>
                                  </div>

                              </div>
                              <div class="portlet-body">
                                  <form method="post" action="${context}/editmunicipalityward"  class="form-horizontal" id ="form_b"
                                      ...
                                      <div class="form-body">
                                          ...
                                          <div class="alert alert-success display-hide">
                                              <button class="close" data-close="alert"></button>
                                              সফলভাবে পৌরসভা ওয়ার্ড সম্পাদন করা হয়েছে !
                                          </div>
                                              ...
                                              <div class="col-md-6">
                                                  <div class="input-icon">
                                                      ...
                                                      <input type="text" data-required="1" class="form-control"
                                                             placeholder=" ইংরেজিতে পৌরসভা  ওয়ার্ড  নাম  লিখুন"
                                                             name="municipalitywardnameeng" value="${municipalityward.getWardNameEng()}">
                                          ...
                                          <div class="form-group">
                                              <label class=" col-md-3 control-label">পৌরসভা  ওয়ার্ড  নাম (বাংলাতে) <span
                                                      class="required" aria-required="true"> * </span></label>
                                              ...
                                              <div class="col-md-6">
                                                  <div class="input-icon">
                                                      ...
                                                      <input type="text" data-required="1" class="form-control"
                                                             ...
                                                             name="municipalitywardnamebng" value="${municipalityward.getWardNameBng()}">
                                              ...
                                              <div class="col-md-6">
                                                  <div class="input-icon">
                                                      ...
                                                      <input type="text" data-required="1" class="form-control"
                                                             ...
                                                             name="municipalitywardbbscode" value="${municipalityward.getBbsCode()}">
                                          ...
                                          <input type="hidden" data-required="1" class="form-control"
                                                 ...
                                                 name="id" value="${municipalityward.getId()}">
                                              ...
                                              <div class="col-md-6">
                                                  <select class="form-control" name="divdata" id="divisiondropdown">
                                                      ...
                                                      <c:forEach var="data" items="${division}">
                                                          <c:choose>
                                                              <c:when test="${municipalityward.getGeoDivisionId() == data.getId()}">
                                              ...
                                              <div class="col-md-6">
                                                  <select class="form-control" name="disdata" id="districtdropdown">
                                                      ...
                                                      <c:forEach var="data" items="${district}">
                                                          ...
                                                          <c:choose>
                                                              <c:when test="${municipalityward.getGeoDistrictId() == data.getId()}">
                                                                  <option value="${data.getId()}" data-bbs = "${data.getBbsCode()}" selected="selected">
                                                                          ${data.getDistrictNameBng()}
                                                                  </option>
                                                              </c:when>
                                              ...
                                              <div class="col-md-6">
                                                  <select class="form-control" name="upadata" id="upazilladropdown">
                                                      ...
                                                      <c:forEach var="data" items="${upazilla}">
                                                          ...
                                                          <c:choose>
                                                              <c:when test="${municipalityward.getGeoUpazilaId() == data.getId()}">
                                                                  <option value="${data.getId()}" data-bbs = "${data.getBbsCode()}" selected="selected">
                                          ...
                                          <div class="form-group">
                                              ...
                                              <div class="col-md-6">
                                                  <select class="form-control" name="mundata" id="municipalitydropdown">
                                                      <%--<option value="-1">...</option>--%>
                                                      <c:forEach var="data" items="${municipality}">
                                                          <%--<option value="${data.getId()}" data-bbs = "${data.getBbsCode()}">--%>
                                                          <%--${data.getDistrictNameBng()}--%>
                                                          <%--</option>--%>

                                                          <c:choose>
                                                              <c:when test="${municipalityward.getGeoMunicipalityId() == data.getId()}">
                                                                  <option value="${data.getId()}" data-bbs = "${data.getBbsCode()}" selected="selected">
                                                                          ${data.getMunicipalityNameBng()}
                                                                  </option>
                                                              </c:when>
                                                              <c:otherwise>
...
<script> $(document).ready(function() {
    ...
    $( "#target" ).submit(function( event ) {
        ...
        selected = $('#municipalitydropdown').find('option:selected');
        extra = selected.data('bbs');
        $('input[name = municipalitybbscode]').val(extra);
    });
