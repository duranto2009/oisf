                ...
                <div class="card-block">
                    <div class="portlet box " >
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-picture"></i> পৌরসভা  ওয়ার্ড  তালিকা
                            </div>
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="table-scrollable table-responsive">
                                <table class="table  table-striped table-hover" id="datatable">
                                    ...
                                    <tr>
                                        <th> পৌরসভা  ওয়ার্ড  (ইংরেজিতে)  </th>
                                        <th> পৌরসভা  ওয়ার্ড  (বাংলাতে) </th>
                                        <th> বি বি এস কোড </th>
            ...
            <div style="display: none">
                ...
                <div id="edit">
                    <form  method="post">
                        ...
                        <input type="hidden" name="municipalitywardnameeng">
                        <input type="hidden" name="municipalitywardnamebng">
                        <input type="hidden" name="municipalitywardbbscode">
                        <input type="hidden" name="divisionbbscode">
                        <input type="hidden" name="districtbbscode">
                        <input type="hidden" name="upazillabbscode">
                        <input type="hidden" name="municipalitybbscode">
                        <input type="hidden" name="divId">
                        <input type="hidden" name="disId">
                        <input type="hidden" name="upaId">
                        <input type="hidden" name="munId">
...
<script>
    ...
    function datatableInit(edi,del,his) {
        ...
        example_table = $('#datatable').DataTable({
            ...
            "language":{
                "decimal":        "১",
                "emptyTable":     "ওয়ার্ড খুজে পাওয়া যায় নাই",
                "info":           " মোট _TOTAL_ ওয়ার্ডের মধ্যে _START_ থেকে _END_ পর্যন্ত দেখানো হচ্ছে",
                "infoEmpty":      "ওয়ার্ড খুজে পাওয়া যায় নাই",
                ...
                "search":         " খুঁজুন:",
                "zeroRecords":    "ওয়ার্ড খুজে পাওয়া যায় নাই",
                "paginate": {
                    "first":      "প্রথম",
                    "last":       "শেষ",
                    "next":       "পরে",
            ...
            "sAjaxSource" : "<%=request.getContextPath()%>/municipalitywardpagedata",
            "iDisplayLength": 10,
            "iDisplayStart": 0,
            "aoColumns"   :[
                {   "mData": 'wardNameEng',
                ...
                },
                {
                    "mRender": function(data, type, full) {
                        ...
                        editbtn.attr('action', "${context}/municipalitywardedit");
                        $('input[name="id"]',editbtn).val(full.id);
                        $('input[name="municipalitywardnameeng"]',editbtn).val(full.wardNameEng);
                        $('input[name="municipalitywardnamebng"]',editbtn).val(full.wardNameBng);
                        $('input[name="municipalitywardbbscode"]',editbtn).val(full.bbsCode);
                        ...
                        $('input[name="municipalitybbscode"]',editbtn).val(full.municipalityBbsCode);
                        ...
                        $('input[name="munId"]',editbtn).val(full.geoMunicipalityId);
                        return editdiv.html();
                    },
                    "bVisible":evisible,
                    "bSortable": false
                ...
                {
                    "mRender": function(data, type, full) {
                        return '<button class="btn btn-icon-only" style="background-color: black;color: white" onclick=showModal('+full.id+',\"/municipalitywarddelete\",msg.trim())>'+
                ...
                },
                {
                    "mRender": function(data, type, full) {
                        ...
                        var link = '<a href="${context}/municipalitywardhistory?id='+full.id+'&&name='+full.wardNameBng+'"><button class="btn btn-icon-only"><i class="fa fa-info" style="color: black"></i></button></a>';
                        return link;
                    },
                    "bVisible":hvisible,
                    "bSortable": false
    ...
    $(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (list[2] == 1) addassign.append('<button type="button" class="btn " style="margin-right: 30px; background-color: #adadce"><a href="${context}/municipalitywardadd">পৌরসভা  ওয়ার্ড  তৈরি করুন </a></button>');
