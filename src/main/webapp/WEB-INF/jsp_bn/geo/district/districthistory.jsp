...
<script>
    ...
    function childDetail(data) {
        ...
        for (var key in upalist)
        {
            ...
            if(l[0].divisionStatus == 1 )fromWhomDistrictBuildUp += '<li> <a href="${context}/divisionhistory?id='+l[0].divisionId+'&&name='+l[0].divisionName+'">'+l[0].divisionName+'</a> বিভাগের ';
            else  fromWhomDistrictBuildUp += '<li> '+l[0].divisionName+ 'বিভাগের ' ;

            if(l[0].districtStatus == 1 )fromWhomDistrictBuildUp += ' <a href="${context}/districthistory?id='+l[0].districtId+'&&name='+l[0].districtName+'">'+l[0].districtName+'</a> জেলার <ul>';
            else fromWhomDistrictBuildUp += l[0].districtName+' জেলার <ul>';
    ...
    function makeSentence(previous, current) {
        ...
        if(binarySentence[0]==0)
        {
            if(current.divisionStatus == 1 )exactSentence += '<a href="${context}/divisionhistory?id='+current.divisionId+'&&name='+current.divisionName+'">'+current.divisionName+'</a> বিভাগের অধীনে ';
            else exactSentence += current.divisionName+' বিভাগের অধীনে ';
        }
