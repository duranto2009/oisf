                           ...
                           <div class="col-md-12">
                               ...
                               <div class="portlet box bordered">
                                   ...
                                   <div class="portlet-body">
                                       <form method="post" action="/assigndistrictupazilla">
                                           <div class=" form-body" style="display: flex;flex-direction: column">
                                               ...
                                               <div class="form-group col-md-12">
                                                   ...
                                                   <label class="control-label col-md-12" style="width: auto"> উপজেলা নির্বাচন করুন </label>
...
<script>
    ...
    function fetchall() {
        ...
        url = "<%=request.getContextPath()%>/getupazilalistbydistrictids"
                ...
                for(i=0;i<selected.length;i++) {
                    ...
                    $.each(data, function (index, value) {
                        if (value.geoDistrictId == values[i]) {
                            select.find('optGroup').last().append($('<option></option>').val("i:"+value.id+":"+3).html(value.upazillaNameBng));
                        }
                    });
