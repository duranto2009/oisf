                ...
                <div class="card-block">
                    <div class="portlet box " >
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-picture"></i> জেলা তালিকা
                            </div>
            ...
            "aoColumns"   :[
                ...
                },
                {
                    "mRender": function(data, type, full) {
                        ...
                        editbtn.attr('action', "${context}/districtedit");
                ...
                {
                    "mRender": function(data, type, full) {
                        return '<button class="btn btn-icon-only" style="background-color: black;color: white" onclick=showModal('+full.id+',\"/districtedelete\",msg.trim())>'+
                ...
                },
                {
                    "mRender": function(data, type, full) {
                        ...
                        var link = '<a href="${context}/districthistory?id='+full.id+'&&name='+full.districtNameBng+'"><button class="btn btn-icon-only"><i class="fa fa-info" style="color: black"></i></button></a>';
                        return link;
                    },
                    "bVisible":hvisible,
                    "bSortable": false
...
//            datatable.clear();
            ...
            $.ajax({
                type: "GET",
                url: "${context}/districtlistdatabydivision",
                data: {
      ...
      //  $("body > div.page-container > div.page-content-wrapper > div > div.card > div > div > div.portlet-body > div.table-scrollable.table-responsive").css('display','none');
        $.ajax({
            ...
            success : function(response) {
                ...
                if(list[2]==1)addassign.append('<button type="button" class="btn " style="margin-right: 30px; background-color: #adadce"><a href="${context}/districtadd"> জেলা তৈরি করুন </a></button>');
                if(list[5]==1){
                    addassign.append('<button type="button" class="btn " style="margin-right: 30px; background-color: #adadce"><a href="${context}/districtupazillaassign"> উপজেলা অন্তর্ভুক্ত করুন </a></button>')
                    addassign.append('<button type="button" class="btn " style="margin-right: 30px; background-color: #adadce"><a href="${context}/districtthanaassign"> থানা অন্তর্ভুক্ত করুন </a></button>')
                };
