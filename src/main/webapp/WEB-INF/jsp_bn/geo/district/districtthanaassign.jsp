...
<head>
    ...
    <style type="text/css">
        ...
        .ms-selectable  ul > li.ms-optgroup-label
        {
            color :red;
        }
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet box bordered">
                                    ...
                                    <div class="portlet-body">
                                        <form method="post" action="${context}/assigndistrictthana">
                                            <div class=" form-body" style="display: flex;flex-direction: column;">
                                                ...
                                                <div class="form-group col-md-12">
                                                    <label class="col-md-3 control-label" style="margin-left: -30px;">নতুন তৈরিকৃত জেলা </label>
                                                    <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label for="multiple" class="control-label"> জেলা নির্বাচন করুন </label>
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <label class="control-label col-md-12" style="width: auto"> থানা নির্বাচন করুন </label>
...
<script>
    ...
    function fetchall() {
        ...
        $.ajax({
            type:"POST",
            url :"${context}/getthanalistbydistrictids",
            data : {
                id: values
            },
            async: false,
            success : function(response) {
                ...
                for(i=0;i<selected.length;i++) {
                    ...
                    $.each(data, function (index, value) {
                        if (value.geoDistrictId == values[i]) {
                            select.find('optGroup').last().append($('<option></option>').val("i:"+value.id+":"+5).html(value.thanaNameBng+" থানা"));
                        }
                    });
    ...
    $(document).ready(function () {
        ...
        $("#districtdropdown").change(function () {
            fetchSibling($("#divisiondropdown").val());
        })
