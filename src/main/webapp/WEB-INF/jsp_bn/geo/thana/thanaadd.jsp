                            ...
                            <div class="portlet box bordered ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-dark sbold uppercase"> থানা তৈরি করুন </span>
                                    </div>

                                </div>
                                <div class="portlet-body">
                                    <form method="post" action="${context}/addthana"  class="form-horizontal"
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                <label class=" col-md-3 control-label"> থানার নাম  (বাংলাতে) <span
                                                        class="required" aria-required="true"> * </span></label>
