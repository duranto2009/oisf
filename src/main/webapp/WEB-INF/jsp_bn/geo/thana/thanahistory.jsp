...
//        else binarySentence.push(0);
        ...
        {
            if(current.districtStatus ==1)exactSentence += '<a href="${context}/districthistory?id='+current.districtId+'&&name='+current.districtName+'">'+current.districtName+'</a>'+" জেলার অধীনে ";
            else exactSentence += current.districtName+" জেলার অধীনে ";
        }
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                else pd =  "পূর্বে থানাটি অন্য কোন জেলার অধীনে ছিল না।";
