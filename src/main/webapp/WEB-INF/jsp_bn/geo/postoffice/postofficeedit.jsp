                          ...
                          <div class="portlet box bordered ">
                              <div class="portlet-title">
                                  <div class="caption">
                                      ...
                                      <span class="caption-subject font-dark sbold uppercase"> পোস্ট অফিস তথ্য পরিবর্তন করুন </span>
                                  </div>

                              </div>
                              <div class="portlet-body">
                                  <form method="post" action="${context}/editpostoffice"  class="form-horizontal"
                                      ...
                                      <div class="form-body">
                                          ...
                                          <div class="alert alert-success display-hide">
                                              <button class="close" data-close="alert"></button>
                                              সফলভাবে পোস্ট অফিস সম্পাদন করা হয়েছে !
                                          </div>


                                          <div class="form-group">
                                              <label class=" col-md-3 control-label" > পোস্ট অফিসের নাম (ইংরেজিতে)  <span
                                              ...
                                              <div class="col-md-6">
                                                  <div class="input-icon">
                                                      ...
                                                      <input type="text" data-required="1" class="form-control"
                                                             placeholder=" ইংরেজিতে পোস্ট অফিসের নাম লিখুন "
                                          ...
                                          <div class="form-group">
                                              <label class=" col-md-3 control-label">  পোস্ট অফিসের নাম (বাংলাতে)   <span
                                                      class="required" aria-required="true"> * </span></label>
                                              ...
                                              <div class="col-md-6">
                                                  <div class="input-icon">
                                                      ...
                                                      <input type="text" data-required="1" class="form-control"
                                                             placeholder=" বাংলাতে পোস্ট অফিসের নাম লিখুন "
                                          ...
                                          <div class="form-group">
                                              ...
                                              <div class="col-md-6">
                                                  <div class="input-icon">
                                                      ...
                                                      <input type="text" data-required="1" class="form-control"
                                                             placeholder=" পোস্ট অফিসের বি বি এস কোড লিখুন  "
                                          ...
                                          <input type="hidden" data-required="1" value="00" class="form-control"
                                          ...
                                          <div class="form-group">
                                              <label class="col-md-3 control-label"> উপজেলার নাম </label>
                                              <div class="col-md-6">
                                          ...
                                          <div class="form-group">
                                              <label class="col-md-3 control-label"> থানার নাম </label>
                                              <div class="col-md-6">
                                      ...
                                      <div class="form-actions">
                                          <div class="row">
                                              <div class="col-md-offset-3 col-md-9">
                                                  ...
                                                  <button type="button"  onclick = "location.href='<%=request.getContextPath()%>/postofficelist?menuid=${sessionScope.postofficemenuid}'" class="btn btn-circle grey-salsa btn-outline"> বাতিল করুন  </button>
                                              </div>
                                          </div>
                                      </div>
                                  </form>
