                         ...
                         <div class="portlet box bordered " >
                             <div class="portlet-title">
                                 <div class="caption">
                                     ...
                                     <span class="caption-subject font-dark sbold uppercase"> পোস্ট অফিস তৈরি করুন</span>
                                 </div>

                             </div>
                             <div class="portlet-body">
                                 <form method="post" action="${context}/addpostoffice"  class="form-horizontal"
                                     ...
                                     <div class="form-body">
                                         ...
                                         <div class="alert alert-success display-hide">
                                             <button class="close" data-close="alert"></button>
                                             সফলভাবে পোস্ট অফিস  যুক্ত করা হয়েছে !
                                         </div>
