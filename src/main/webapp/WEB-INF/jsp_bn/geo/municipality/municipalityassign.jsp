                           ...
                           <div class="col-md-12">
                               ...
                               <div class="portlet box bordered">
                                   <div class="portlet-title ">
                                       <div class="caption">
                                           <span class="caption-subject"> ইউনিয়ন নিয়োগ</span>
                                       </div>
                                   </div>
                                   <div class="portlet-body">
                                       <form method="post" action="/assignmunicipality">
                                           <div class=" form-body" style="display: flex;flex-direction: column;">
                                               <div class="form-group col-md-12">
                                                   <label class="col-md-3 control-label" style="margin-left: -30px;"> বিভায়ের নাম </label>
                                                   <div class="col-md-6">
                                               ...
                                               <div class="form-group col-md-12">
                                                   <label class="col-md-3 control-label" style="margin-left: -30px;"> জেলার নাম </label>
                                                   <div class="col-md-6">
                                               ...
                                               <div class="form-group col-md-12">
                                                   <label class="col-md-3 control-label" style="margin-left: -30px;"> উপজেলার নাম </label>
                                                   <div class="col-md-6">
                                               ...
                                               <div class="form-group col-md-12">
                                                   <label class="col-md-3 control-label" style="margin-left: -30px;"> নতুন তৈরিকৃত পৌরসভা </label>
                                                   <div class="col-md-6">
                                                       <select class="form-control" name="munidata" id="municipalitydropdown">
                                               ...
                                               <div class="form-group">
                                                   ...
                                                   <label for="multiple" class="control-label"> উপজেলা নির্বাচন করুন </label>
                                               ...
                                               <div class="form-group col-md-12">
                                                   ...
                                                   <label class="control-label col-md-12" style="width: auto"> ইউনিয়ন নির্বাচন করুন </label>
                                           ...
                                           <div class="form-actions">
                                               <div class="row">
                                                   <div class=" col-md-3" style="margin-left: 40%">
                                                       ...
                                                       <button type="button" onclick = "location.href='<%=request.getContextPath()%>/municipalitylist?menuid=${sessionScope.municipalitymenuid}'" class="btn btn-circle grey-salsa btn-outline"> বাতিল করুন </button>
...
<script>
    ...
    function fetchall() {
        ...
        $.ajax({
            type:"POST",
            url :"${context}/getunionlistbyupazillaids",
            data : {
                id: values
            },
            async: false,
    ...
    function fetchSibling() {
        var url =null;
        var upazilla = $("#upazilladropdown option:selected");
        var value = upazilla.val();
        var name = upazilla.text();
        var bbsCode = upazilla.data('bbs');

        var select = $('#multiple');
        select.empty();

            select.append(
                $('<option></option>').val(value).html(name).attr('bbs',bbsCode)
            );
