                           ...
                           <div class="portlet box bordered ">
                               <div class="portlet-title">
                                   <div class="caption">
                                       ...
                                       <span class="caption-subject font-dark sbold uppercase">পৌরসভা তথ্য পরিবর্তন করুন </span>
                                   </div>

                               </div>
                               <div class="portlet-body">
                                   <form method="post" action="${context}/editmunicipality"  class="form-horizontal"
                                       ...
                                       <div class="form-body">
                                           ...
                                           <div class="alert alert-success display-hide">
                                               <button class="close" data-close="alert"></button>
                                               সফলভাবে পৌরসভা সম্পাদন করা হয়েছে !
                                           </div>
                                           ...
                                           <div class="form-group">
                                               ...
                                               <div class="col-md-6">
                                                   <div class="input-icon">
                                                       ...
                                                       <input type="text" data-required="1" class="form-control"
                                                              placeholder="পৌরসভা  বি বি এস  কোড"
