            ...
            <div class="card">
                    ...
                    <div class="portlet box " >
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-picture"></i>পৌরসভা  তালিকা
                            </div>
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="table-scrollable table-responsive">
                                <table class="table  table-striped table-hover" id="datatable">
                                    ...
                                    <tr>
                                        <th>পৌরসভা   নাম ( ইংরেজিতে)  </th>
                                        <th>পৌরসভা   নাম (বাংলাতে) </th>
                                        <th> বি বি এস কোড </th>
            ...
            <div style="display: none">
                ...
                <div id="edit">
                    <form  method="post">
                        ...
                        <input type="hidden" name="municipalitynameeng">
                        <input type="hidden" name="municipalitynamebng">
...
<script>
    ...
    function datatableInit(edi,del,his) {
        ...
        example_table = $('#datatable').DataTable({
            ...
            "language":{
                "decimal":        "১",
                "emptyTable":     "পৌরসভা খুজে পাওয়া যায় নাই",
                "info":           " মোট _TOTAL_ পৌরসভার মধ্যে _START_ থেকে _END_ পর্যন্ত দেখানো হচ্ছে",
                "infoEmpty":      "পৌরসভা খুজে পাওয়া যায় নাই",
                ...
                "search":         " খুঁজুন :",
                "zeroRecords":    "পৌরসভা খুজে পাওয়া যায় নাই",
                "paginate": {
                    "first":      "প্রথম",
                    "last":       "শেষ",
                    "next":       "পরে",
            ...
            "sAjaxSource" : "<%=request.getContextPath()%>/municipalitypagedata",
            "iDisplayLength": 10,
            "iDisplayStart": 0,
            "aoColumns"   :[
                {   "mData": 'municipalityNameEng',
                    "bSortable": false
                },
                {   "mData":'municipalityNameBng',
                    "bSortable": false
                },
                {   "mData":'bbsCode',
                    "bSortable": false
                },
                {
                    "mRender": function(data, type, full) {
                        ...
                        editbtn.attr('action', "<%=request.getContextPath()%>/municipalityedit");
                        $('input[name="id"]',editbtn).val(full.id);
                        $('input[name="municipalitynameeng"]',editbtn).val(full.municipalityNameEng);
                        $('input[name="municipalitynamebng"]',editbtn).val(full.municipalityNameBng);
                        $('input[name="municipalitybbscode"]',editbtn).val(full.bbsCode);
                ...
                {
                    "mRender": function(data, type, full) {
                        return '<button class="btn btn-icon-only" style="background-color: black;color: white" onclick=showModal('+full.id+',\"/municipalitydelete\",msg.trim())>'+
                ...
                },
                {
                    "mRender": function(data, type, full) {
                        ...
                        var link = '<a href="${context}/municipalityhistory?id='+full.id+'&&name='+full.municipalityNameBng+'">' +
                            '<button class="btn btn-icon-only"><i class="fa fa-info" style="color: black"></button></i></a>';
                        return link;
                    },
                    "bVisible":hvisible,
                    "bSortable": false
    ...
    $(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (list[2] == 1) addassign.append('<button type="button" class="btn " style="margin-right: 30px; background-color: #adadce"><a href="${context}/municipalityadd">পৌরসভা  তৈরি করুন </a></button>');
                if (list[5] == 1) addassign.append('<button type="button" class="btn " style="margin-right: 30px; background-color: #adadce"><a href=${context}"/municipalityassign">পৌরসভা   অন্তর্ভুক্ত করুন </a></button>');
