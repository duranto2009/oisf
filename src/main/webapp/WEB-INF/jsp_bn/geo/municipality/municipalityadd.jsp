                          ...
                          <div class="portlet box bordered ">
                              <div class="portlet-title">
                                  <div class="caption">
                                      ...
                                      <span class="caption-subject font-dark sbold uppercase">পৌরসভা  তৈরি করুন </span>
                                  </div>

                              </div>
                              <div class="portlet-body">
                                  <form method="post" action="${context}/addmunicipality"  class="form-horizontal"
                                      ...
                                      <div class="form-body">
                                          ...
                                          <div class="alert alert-success display-hide">
                                              <button class="close" data-close="alert"></button>
                                              সফলভাবে পৌরসভা যুক্ত করা হয়েছে !
                                          </div>


                                          <div class="form-group">
                                              <label class=" col-md-3 control-label" >পৌরসভা  নাম  (ইংরেজিতে)<span
                                              ...
                                              <div class="col-md-6">
                                                  <div class="input-icon">
                                                      ...
                                                      <input type="text" data-required="1" class="form-control"
                                                             placeholder="ইংরেজিতে পৌরসভা  নাম  লিখুন"
                                                             name="municipalitynameeng">
                                          ...
                                          <div class="form-group">
                                              <label class=" col-md-3 control-label">পৌরসভা  নাম (বাংলাতে) <span
                                                      class="required" aria-required="true"> * </span></label>
                                              ...
                                              <div class="col-md-6">
                                                  <div class="input-icon">
                                                      ...
                                                      <input type="text" data-required="1" class="form-control"
                                                             placeholder="বাংলায় পৌরসভা  নাম লিখুন"
                                                             name="municipalitynamebng">
