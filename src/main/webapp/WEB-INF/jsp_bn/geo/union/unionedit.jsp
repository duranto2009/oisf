                          ...
                          <div class="portlet box bordered " >
                              <div class="portlet-title">
                                  <div class="caption">
                                      ...
                                      <span class="caption-subject font-dark sbold uppercase"> ইউনিয়নের তথ্য পরিবর্তন করুন</span>
                                  </div>

                              </div>
                              <div class="portlet-body">
                                  <form method="post" action="${context}/editunion"  class="form-horizontal"
                                      ...
                                      <div class="form-body">
                                          ...
                                          <div class="alert alert-success display-hide">
                                              <button class="close" data-close="alert"></button>
                                              সফলভাবে ইউনিয়ন সম্পাদন করা হয়েছে !
                                          </div>
                                      ...
                                      <div class="form-actions">
                                          <div class="row">
                                              <div class="col-md-offset-3 col-md-9">
                                                  ...
                                                  <button type="button"  onclick = "location.href='<%=request.getContextPath()%>/unionlist?menuid=${sessionScope.unionmenuid}'" class="btn btn-circle grey-salsa btn-outline"> বাতিল করুন </button>
                                              </div>
                                          </div>
                                      </div>
                                  </form>
