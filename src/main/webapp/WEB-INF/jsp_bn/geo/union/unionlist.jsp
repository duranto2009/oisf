                ...
                <div class="card-block">
                    <div class="portlet box ">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-picture"></i> ইউনিয়ন তালিকা
                            </div>
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="table-scrollable table-responsive">
                                <table class="table  table-striped table-hover" id="datatable">
                                    ...
                                    <tr>
                                        <th> ইউনিয়নের নাম (ইংরেজিতে)</th>
                                        <th> ইউনিয়নের নাম (বাংলাতে)</th>
                                        <th> বি বি এস কোড</th>
            ...
            <div style="display: none">
                ...
                <div id="edit">
                    <form method="post">
                        ...
                        <input type="hidden" name="unionnameeng">
                        <input type="hidden" name="unionnamebng">
                        <input type="hidden" name="unionbbscode">
                            ...
                            <div class="dropdown dropdown-lg">
                                ...
                                <div class="dropdown-menu dropdown-menu-right advanced-file-search" role="menu"
                                    ...
                                    <div>
                                        ...
                                        <label class="control-label"> উপজেলা <span
                                                class="required" aria-required="true"> * </span></label>

                                        <select class="form-control" name="disdata" id="upazilladropdown">
                                        </select>
...
<script>
    ...
    function datatableInit(edi, del, his) {
        ...
        example_table = $('#datatable').DataTable({
            ...
            "sAjaxSource": "<%=request.getContextPath()%>/unionpagedata",
            "iDisplayLength": 10,
            "iDisplayStart": 0,
            "aoColumns": [
                {
                ...
                },
                {
                    "mRender": function (data, type, full) {
                        ...
                        editbtn.attr('action', "${context}/unionedit");
                        $('input[name="id"]', editbtn).val(full.id);
                        $('input[name="unionnameeng"]', editbtn).val(full.unionNameEng);
                        $('input[name="unionnamebng"]', editbtn).val(full.unionNameBng);
                        $('input[name="unionbbscode"]', editbtn).val(full.bbsCode);
                ...
                {
                    "mRender": function (data, type, full) {
                        return '<button class="btn btn-icon-only" style="background-color: black;color: white" onclick=showModal(' + full.id + ',\"/uniondelete\",msg.trim())>' +
...
//                        return historydiv.html();
                        ...
                        var link = '<a href="${context}/unionhistory?id=' + full.id + '&&name=' + full.unionNameBng + '"><button class="btn btn-icon-only"><i class="fa fa-info" style="color: black"></i></button></a>';
                        return link;
                    },
                    "bVisible": hvisible,
                    "bSortable": false
    ...
    $(document).ready(function () {
        $.ajax({
            ...
            success: function (response) {
                ...
                if (list[2] == 1) addassign.append('<button type="button" class="btn " style="margin-right: 30px; background-color: #adadce"><a href="${context}/unionadd"> ইউনিয়ন সংযুক্ত  করুন </a></button>');
