                ...
                <div class="card-block">
                    <div class="portlet box " >
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-picture"></i>  সিটি  কর্পোরেশন ওয়ার্ড  তালিকা
                            </div>
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="table-scrollable table-responsive">
                                <table class="table  table-striped table-hover" id="datatable">
                                    ...
                                    <tr>
                                        <th> সিটি  কর্পোরেশন ওয়ার্ড  ( ইংরেজিতে) </th>
                                        <th> সিটি  কর্পোরেশন ওয়ার্ড  ( বাংলাতে)  </th>
                                        <th>  বি বি এস কোড  </th>
...
<script>
    ...
    function datatableInit(edi,del,his) {
        ...
        example_table = $('#datatable').DataTable({
            ...
            "sAjaxSource" : "<%=request.getContextPath()%>/citycorporationwardpagedata",
            "iDisplayLength": 10,
            "iDisplayStart": 0,
            "aoColumns"   :[
                {   "mData": 'nameEng',
                ...
                },
                {
                    "mRender": function(data, type, full) {
                        ...
                        editbtn.attr('action', "${context}/citycorporationwardedit");
                        $('input[name="id"]',editbtn).val(full.id);
                        $('input[name="wardnameeng"]',editbtn).val(full.nameEng);
                        $('input[name="wardnamebng"]',editbtn).val(full.nameBng);
                        ...
                        $('input[name="citybbscode"]',editbtn).val(full.cityCorporationBbsCode);
                        $('input[name="divdata"]',editbtn).val(full.divisionId);
                        $('input[name="disdata"]',editbtn).val(full.districtId);
                        $('input[name="citydata"]',editbtn).val(full.cityCorporationId);
                ...
                {
                    "mRender": function(data, type, full) {
                        return '<button class="btn btn-icon-only" style="background-color: black;color: white" onclick=showModal('+full.id+',\"/citycorporationwarddelete\",msg.trim())>'+
                ...
                },
                {
                    "mRender": function(data, type, full) {
                        ...
                        var link = '<a href="${context}/citycorporationwardhistory?id='+full.id+'&&name='+full.nameBng+'"><button class="btn btn-icon-only"><i class="fa fa-info" style="color: black"></i></button></a>';
                        return link;
                    },
                    "bVisible":hvisible,
                    "bSortable": false
    ...
    $(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (list[2] == 1) addassign.append('<button type="button" class="btn " style="margin-right: 30px; background-color: #adadce"><a href="${context}/citycorporationwardadd">সিটি  কর্পোরেশন ওয়ার্ড  তৈরি করুন </a></button>');
