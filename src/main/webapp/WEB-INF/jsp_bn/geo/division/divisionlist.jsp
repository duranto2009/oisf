                ...
                <div class="card-block">
                    <div class="portlet box " >
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-picture"></i> বিভাগের তালিকা
                            </div>
                        ...
                        <div class="portlet-body">
                            ...
                            <div class=" table-scrollable table-responsive">
                                    <table class="table  table-striped  table-hover" id="datatable">
                                        ...
                                        <th > বিভাগের নাম ( ইংরেজিতে) </th>
                                        <th > বিভাগের নাম ( বাংলাতে)  </th>
                                        <th > বি বি এস কোড </th>
            ...
            "aoColumns"   :[
                ...
                },
                {
                    "mRender": function(data, type, full) {
                        ...
                        editbtn.attr('action', "${context}/divisionedit");
                ...
                {
                    "mRender": function(data, type, full) {
                        return '<button class="btn btn-icon-only" style="background-color: black;color: white" onclick=showModal('+full.id+',\"/divisiondelete\",msg.trim())>'+
                ...
                },
                {
                    "mRender": function(data, type, full) {
                        ...
                        var link = '<a href="${context}/divisionhistory?id='+full.id+'&&name='+full.divisionNameBng+'"><button class="btn btn-icon-only"><i class="fa fa-info" style="color: black"></i></button></a>';
                        return link;
                    },
                    "bVisible":hvisible,
                    "bSortable": false
...
//                    else  if(x.indexOf("history")>=0)list["history"]={ispresent:1,nameeng:response[i].nameEng,namebng:response[i].nameBng,url:response[i].url};
                ...
                if(list[2]==1)addassign.append('<button type="button" class="btn " style="margin-right: 30px; background-color: #adadce"><a href="${context}/divisionadd"> বিভাগ  তৈরি করুন </a></button>');
                if(list[5]==1)addassign.append('<button type="button" class="btn " style="margin-right: 30px; background-color: #adadce"><a href="${context}/divisionassign">  জেলা অন্তর্ভুক্ত করুন </a></button>');
