                            ...
                            <div class="portlet box bordered ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-dark sbold uppercase"> উপজেলা তৈরি করুন</span>
                                    </div>
                                    ...
                                    <form method="post" action="${context}/addupazilla"  class="form-horizontal"
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="alert alert-success display-hide">
                                                <button class="close" data-close="alert"></button>
                                                সফলভাবে উপজেলা যুক্ত করা হয়েছে !
                                            </div>


                                            <div class="form-group">
                                                <label class=" col-md-3 control-label" >উপজেলার নাম (ইংরেজিতে) <span
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-icon">
                                                        ...
                                                        <input type="text" data-required="1" class="form-control"
                                                               placeholder="উপজেলার নাম (ইংরেজিতে)"
                                            ...
                                            <div class="form-group">
                                                <label class=" col-md-3 control-label">উপজেলার নাম (বাংলাতে) <span
                                                        class="required" aria-required="true"> * </span></label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-icon">
                                                        ...
                                                        <input type="text" data-required="1" class="form-control"
                                                               placeholder="উপজেলার নাম ( বাংলাতে )"
                                            ...
                                            <div class="form-group">
                                                <label class=" col-md-3 control-label"> বিবিএস  কোড <span
                                                        class="required" aria-required="true"> * </span></label>
...
<script> $(document).ready(function() {
    ...
    $('#divisiondropdown').change(function() {
        ...
        $.each(data, function(index, value) {
            select.append($('<option></option>').val(value.id).html(value.districtNameBng).attr('bbs',value.bbsCode));
        });
