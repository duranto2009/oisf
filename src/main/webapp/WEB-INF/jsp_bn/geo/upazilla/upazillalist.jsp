                ...
                <div class="card-block">
                    <div class="portlet box " >
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-picture"></i> উপজেলা  তালিকা
                            </div>
            ...
            "aoColumns"   :[
                ...
                },
                {
                    "mRender": function(data, type, full) {
                        ...
                        editbtn.attr('action', "${context}/upazillaedit");
                ...
                {
                    "mRender": function(data, type, full) {
                        return '<button class="btn btn-icon-only" style="background-color: black;color: white" onclick=showModal('+full.id+',\"/upazilladelete\",msg.trim())>'+
...
//                        return historydiv.html();
                        ...
                        var link = '<a href="${context}/upazillahistory?id='+full.id+'&&name='+full.upazillaNameBng+'"><button class="btn btn-icon-only"><i class="fa fa-info" style="color: black"></i></button></a>';
                        return link;
                    },
                    "bVisible":hvisible,
                    "bSortable": false
    ...
    $(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (list[2] == 1) addassign.append('<button type="button" class="btn " style="margin-right: 30px; background-color: #adadce"><a href="${context}/upazillaadd"> উপজেলা যোগ করুন</a></button>');
                if(list[5]==1){
                    addassign.append('<button type="button" class="btn " style="margin-right: 30px; background-color: #adadce"><a href="${context}/upazillaunionassign"> ইউনিয়ন  অন্তর্ভুক্ত করুন</a></button>')
                    addassign.append('<button type="button" class="btn " style="margin-right: 30px; background-color: #adadce"><a href="${context}/upazillamunicipalityassign"> পৌরসভা অন্তর্ভুক্ত করুন</a></button>')
                };
