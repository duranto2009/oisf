                           ...
                           <div class="portlet box bordered " >
                               <div class="portlet-title">
                                   <div class="caption">
                                       ...
                                       <span class="caption-subject font-dark sbold uppercase"> উপজেলার তথ্য পরিবর্তন করুন</span>
                                   </div>

                               </div>
                               <div class="portlet-body">
                                   <form method="post" action="${context}/editupazilla"  class="form-horizontal"
                                       ...
                                       <div class="form-body">
                                           ...
                                           <div class="alert alert-success display-hide">
                                               <button class="close" data-close="alert"></button>
                                               সফলভাবে উপজেলা সম্পাদন করা হয়েছে !
                                           </div>


                                           <div class="form-group">
                                               <label class=" col-md-3 control-label" > উপজেলা নাম ইংরেজিতে) <span
                                               ...
                                               <div class="col-md-6">
                                                   <div class="input-icon">
                                                       ...
                                                       <input type="text" data-required="1" class="form-control"
                                                              placeholder=" উপজেলা নাম "
                                                              name="upazillanameeng" value="${upazilla.getUpazillaNameEng()}">
                                           ...
                                           <div class="form-group">
                                               <label class=" col-md-3 control-label"> উপজেলা নাম (বাংলাতে) <span
                                                       class="required" aria-required="true"> * </span></label>
                                               ...
                                               <div class="col-md-6">
                                                   <div class="input-icon">
                                                       ...
                                                       <input type="text" data-required="1" class="form-control"
                                                              placeholder=" উপজেলা নাম "
                                                              name="upazillanamebng" value="${upazilla.getUpazillaNameBng()}">
                                           ...
                                           <div class="form-group">
                                               <label class=" col-md-3 control-label"> উপজেলা বি বি এস কোড<span
                                                       class="required" aria-required="true"> * </span></label>
                                               ...
                                               <div class="col-md-6">
                                                   <div class="input-icon">
                                                       ...
                                                       <input type="text" data-required="1" class="form-control"
                                                              ...
                                                              name="upazillabbscode" value="${upazilla.getBbsCode()}">
                                               ...
                                               <div class="col-md-6">
                                                   <select class="form-control" name="divdata" id="divisiondropdown">
                                                       ...
                                                       <c:forEach var="data" items="${division}">
                                                           <c:choose>
                                                               <c:when test="${upazilla.getGeoDivisionId() == data.getId()}">
                                               ...
                                               <div class="col-md-6">
                                                   <select class="form-control" name="disdata" id="districtdropdown">
                                                       ...
                                                       <c:forEach var="data" items="${district}">
                                                           ...
                                                           <c:choose>
                                                               <c:when test="${upazilla.getGeoDistrictId() == data.getId()}">
                                                                   <option value="${data.getId()}" data-bbs = "${data.getBbsCode()}" selected="selected">
                                                                           ${data.getDistrictNameBng()}
                                                                   </option>
                                                               </c:when>
                                       ...
                                       <div class="form-actions">
                                           <div class="row">
                                               <div class="col-md-offset-3 col-md-9">
                                                   ...
                                                   <button type="button"  onclick = "location.href='<%=request.getContextPath()%>/upazillalist?menuid=${sessionScope.upazillamenuid}'" class="btn btn-circle grey-salsa btn-outline"> বাতিল করুন </button>
                                               </div>
                                           </div>
                                       </div>
                                   </form>
