                        ...
                        <div class="portlet box bordered ">
                            <div class="portlet-title">
                                <div class="caption">
                                    ...
                                    <span class="caption-subject font-dark sbold uppercase"> অফিস মন্ত্রণালয় ফরম</span>
                                </div>
                                ...
                                <form method="post" action="${context}/addministry"  class="form-horizontal" id ="target"
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="alert alert-success display-hide">
                                            <button class="close" data-close="alert"></button>
                                            সফলভাবে মন্ত্রণালয়টি যুক্ত করা হয়েছে !
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-icon">
                                                    ...
                                                    <%--placeholder="অফিসের ধরণ লিখুন" --%>
                                                    <%--name="officetype">--%>
                                                    <select name="officetype" class="form-control" >
                                                        <option value="1" selected="selected">মন্ত্রণালয়</option>
                                        ...
                                        <%--<div class="form-group">--%>
                                            ...
                                            <%--<div class="col-md-6">--%>
                                                <%--<div class="input-icon">--%>
                                                    ...
                                                    <%--<i class="fa fa-angle-double-right tooltips "--%>
                                                       <%--data-original-title="সচল  স্ট্যাটাস কোড  লিখুন"--%>
                                                       <%--data-container="body"></i>--%>

                                                    <%--<input type="text" data-required="1" class="form-control"--%>
                                                           <%--placeholder="সচল  স্ট্যাটাস কোড  লিখুন"--%>
                                                           <%--name="status">--%>
