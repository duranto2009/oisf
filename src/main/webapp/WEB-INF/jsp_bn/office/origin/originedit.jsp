                            ...
                            <div class="portlet box bordered ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-dark sbold"> মৌলিক দপ্তর পরিবর্তন </span>
                                    </div>

                                </div>
                                <div class="portlet-body">
                                    <form method="post" action="${context}/editorigin" class="form-horizontal"
                                          id="target"
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                <label class=" col-md-3 control-label"> মৌলিক দপ্তর স্তর <span
                                                        class="required" aria-required="true"> * </span></label>
                                            ...
                                            <div class="form-group">
                                                <label class=" col-md-3 control-label"> মৌলিক দপ্তর ক্রম <span
                                                        class="required" aria-required="true"> * </span></label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-icon">
                                                        ...
                                                        <input type="text" data-required="1" class="form-control"
                                                               ...
                                                               value="${origin.getOfficeSequence()}">
                                            ...
                                            <div class="form-group">
                                                <label class=" col-md-3 control-label"> দপ্তর স্তর <span
                                                        class="required" aria-required="true"> * </span></label>
        ...
        $('#layerdropdown').change(function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    select.empty();
                    select.append($('<option></option>').val(-1).prop('disabled', 'disabled').html('--নির্বাচন করুন--'));
                    $.each(data, function (index, value) {
                        select.append(
