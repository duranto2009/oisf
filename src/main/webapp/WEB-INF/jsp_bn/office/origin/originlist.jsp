                ...
                <div class="card-block">
                    <div class="portlet box " >
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-picture"></i> মৌলিক দপ্তরের তালিকা
                            </div>
                            ...
                            <div class="table-scrollable table-responsive">
                                <table class="table  table-striped table-hover" id="datatable">
                                    ...
                                    <tr>
                                        ...
                                        <th>  মৌলিক দপ্তরের নাম (ইংরেজিতে) </th>
                                        <th>  মৌলিক দপ্তরের নাম (বাংলা) </th>
                                        <th>  দপ্তরের স্তর </th>
                                        <th>  দপ্তরের ক্রম </th>
    ...
    function datatableInit(edi,del,his) {
        ...
        example_table = $('#datatable').DataTable({
            ...
            "aoColumns"   :[
                ...
                {
                    "mRender": function(data, type, full) {
                        return '<button class="btn btn-icon-only" style="background-color: black;color: white" onclick=showModal('+full.id+',\"/origindelete\",msg.trim())>'+
    ...
    $(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (list[2] == 1) addassign.append('<button type="button" class="btn " style="margin-right: 30px; background-color: #b5b1b1"><a href="${context}/originadd">মৌলিক দপ্তর তৈরি</a></button>');
