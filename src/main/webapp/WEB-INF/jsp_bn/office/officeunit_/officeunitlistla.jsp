        ...
        <div class="page-content">
            ...
            <div class="portlet box ">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-picture"></i>Office Unit Organogram
                    </div>
                </div>
                    ...
                    <div style="display: flex;justify-content: space-between;align-items: flex-start">
                        ...
                        <div class="portlet light no-shadow" style="width: 49%">
                            <div class="portlet-title" style="position: relative">
                                <div class="caption">
                                    <img src="../assets/img/brance.png" style="    height: 30px;   width: 30px;">মৌলিক শাখার তালিকা
                                </div>
                        ...
                        <div class="portlet light  no-shadow" style="width: 49%">
                            <div class="portlet-title" style="position: relative">
                                <div class="caption">
                                    <img src="../assets/img/brance.png" style="    height: 30px;   width: 30px;">
                                    অফিস শাখার তালিকা
                                </div>
...
//        });
    ...
    function childList2(parentId,data) {
        var  childs =[];
        for(var i=0; i<data.length; i++){
            if(data[i].parentOriginUnitId == parentId)childs.push(data[i]);
        }
        return childs;
    }
    ...
    function layerStructure2(id, data) {
        ...
        for(var i=0;i<childs.length;i++){
            jsonforjstree += '{ "id" : "'+childs[i].id+'",';
            var checkChild = childList2(childs[i].officeOriginUnitId,data);
//            if(checkChild.length ==0)jsonforjstree += '  "text" : "'+childs[i].unitNameBng+'<a  title=\'এই স্তরটি বাতিল করুন\' class=\'red equ\'  onclick=showModal(\''+childs[i].id+'\',\'/deleteoriginunit\')><i class=\'fa fa fa-minus-circle\'></i></a>",';
            /*else*/ jsonforjstree += '  "text" : "'+childs[i].unitNameBng.trim()+'",';
            jsonforjstree += '  "icon" : "uniticon",';
            jsonforjstree += '  "li_attr" : {"ul" : "'+childs[i].unitLevel+'","ouc" : "'+childs[i].officeUnitCategory+'","maxlevel" : "'+childs.length+'","bng" : "'+childs[i].unitNameBng.trim()+'","eng" : "'+childs[i].unitNameEng.trim()+'"},';
//            jsonforjstree += '  "children" : '+layerStructure1(childs[i].id,data)+'},';
            jsonforjstree += (childs.length - 1 == i) ? '"children" : ' + layerStructure2(childs[i].officeOriginUnitId, data) + '}' : '  "children" : ' + layerStructure2(childs[i].officeOriginUnitId, data) + '},';
        }
