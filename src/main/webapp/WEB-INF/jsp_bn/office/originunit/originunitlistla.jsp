        ...
        <div class="page-content">
            <div class="portlet box " >
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-picture"></i>  দপ্তর শাখার তালিকা
                    </div>
                </div>
...
<script>
    ...
    function layerStructure(id, data) {
        ...
        for(var i=0;i<childs.length;i++){
            ...
            if(checkChild.length ==0)jsonforjstree += '  "text" : "'+childs[i].unitNameBng.trim()+'<a  title=\'এই স্তরটি বাতিল করুন\' class=\'red equ\'  onclick=showModal(\''+childs[i].id+'\',\'/deleteoriginunit\')></a>",';
        ...
        jsonforjstree += '{  "text" : "<a  title=\'এই স্তরটি বাতিল করুন\' class=\'red equ\'></a>",';
        jsonforjstree += '  "icon" : "icon icon-arrow-right",';
