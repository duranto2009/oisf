...
public class OfficeUnitDTO {
    ...
    public OfficeUnitDTO() {
    }

    public OfficeUnitDTO(int id, int officeMinistryId, int officeLayerId, int officeId, int officeOriginUnitId, String unitNameBng, String unitNameEng, String officeUnitCategory, int parentUnitId, int parentOriginUnitId, String unitNothiCode, int unitLevel, int sarokNoStart, byte status, int createdBy, int modifiedBy, Timestamp created, Timestamp modified) {
        this.id = id;
    ...
    public OfficeUnitDTO(int id, String unitNameBng) {
        this.id = id;
        this.unitNameBng = unitNameBng;
    }
    ...
    public boolean equals(Object o) {
        ...
        OfficeUnitDTO that = (OfficeUnitDTO) o;
