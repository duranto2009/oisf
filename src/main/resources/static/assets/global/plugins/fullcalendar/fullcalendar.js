...
// When isSame is called with officeunit, timezone ambiguity is normalized before the comparison happens.
// If no officeunit are specified, the two moments must be identically the same, with matching ambig flags.
...
$.extend(DayGrid.prototype, {
	...
	// Limits the number of "levels" (vertically stacking layer of events) for each row of the grid.
