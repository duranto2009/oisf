...
var app = angular.module('OfflineDakNagorik', ['ui.tinymce', 'ui.bootstrap', 'ngRoute', 'ngSanitize', 'MassAutoComplete', 'ngFileUpload','angularLocalStorage']);
...
app.controller('OfflineDakNagorikControllers', ['$scope', '$sce', '$q', 'Upload', '$filter', '$interval','StorageService','$timeout', function ($scope, $sce, $q, Upload, $filter, $interval,storage,$timeout) {
        ...
        var addTab = function () {
            $scope.tabs.push({tab: counter, title: 'New Nagorik Dak ' + counter, constTitle: 'New Nagorik Dak ' + counter, openTab: true, mailTo: ''});
